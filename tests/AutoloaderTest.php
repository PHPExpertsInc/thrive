...
class TestableThrive_Autoloader extends Thrive_Autoloader
{
	public function __construct()
	{
		echo "Running the Testable Thrive Autoloader (Hash: ". spl_object_hash($this) .")...\n";
		parent::__construct();
	}
	...
	public function autoload($className)
	{
		...
		echo "Class: $className | File: $filename\n";
